        ...
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
            ...
            <footer className="siteFooter" style={{
                ...
                <div className="siteFooterContactBlock" style={{
                    ...
                    <svg className="siteFooterLocationIcon" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="rgba(255,255,255,0.85)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
