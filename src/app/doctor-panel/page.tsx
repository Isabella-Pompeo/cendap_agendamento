...
import { Camera, FileText, Download, Upload, LogOut, User as UserIcon, Stethoscope, CalendarDays, CheckCircle, Phone, Fingerprint, Copy, RefreshCw, Paperclip, Image as ImageIcon } from 'lucide-react';
                    ...
                    <div>
                      ...
                      <div style={{ marginTop: '16px', display: 'flex', flexDirection: 'column', gap: '12px' }}>
                        ...
                        <div style={{ padding: '12px', backgroundColor: '#f8fafc', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
                          ...
                          >
                            {isUploading ? (
                              <span style={{ fontSize: '0.85rem' }}>Enviando...</span>
                            ) : (
                              <>
